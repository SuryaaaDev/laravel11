...
<body class="bg-gray-100">
    <div class="flex h-screen justify-center items-center">
        <div class="max-w-xl p-16 rounded-xl shadow-xl bg-white">
            ...
            <form action="{{ route('book.update', $book->id) }}" method="post" class="flex flex-col gap-5">
                @csrf
                ...
                <label for="title"
                    ...
                    <input type="text" id="title"
                        ...
                        placeholder="Judul" name="title" value="{{ $book->title }}" />
                ...
                <label for="author"
                    ...
                    <input type="text" id="author"
                        class="peer border-none bg-transparent px-4 h-10 w-72 placeholder-transparent focus:border-transparent focus:ring-0 focus:outline-hidden"
                        placeholder="Pengarang" name="author" value="{{ $book->author }}" />
                ...
                <label for="year"
                    ...
                    <input type="text" id="year"
                        class="peer border-none bg-transparent px-4 h-10 w-72 placeholder-transparent focus:border-transparent focus:ring-0 focus:outline-hidden"
                        placeholder="Tahun Terbit" name="year" value="{{ $book->year }}" />
